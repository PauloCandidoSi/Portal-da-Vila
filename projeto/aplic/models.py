...
class Usuario(models.Model):
    ...
    telefone = models.CharField(('Telefone'), blank=True, max_length=11, help_text=_('Formato (00) 00000-0000'))
...
class Residente(Usuario):
    data_nascimento = models.DateField(_('Data de Nascimento'), blank=True, null=True,
                                       help_text=_('Formato DD/MM/AAAA'))
    foto = StdImageField(('Imagem'), null=True, blank=True, upload_to=get_file_path,
                         variations={'thumb': {'width': 420, 'height': 260, 'crop': True}})
...
class Responsavel(models.Model):
    telefone = models.CharField(('Telefone'), blank=True, max_length=11, help_text=_('Formato (00) 0000-0000'))
    celular = models.CharField(('Celular'), blank=True, max_length=11, help_text=_('Formato (00) 00000-0000'))
    telefone_comercial = models.CharField(('Tel. Comercial'), blank=True, max_length=11, help_text=_('Formato (00) 0000-0000'))
